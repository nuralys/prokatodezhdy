...
<input type="text" required="required" name="data[Partner][imgsource]" class="imgsource" value="" />
<input type="text" required="required" name="data[Partner][imgcrop]" class="imgcrop" value="" />
<?
